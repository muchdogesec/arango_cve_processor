import argparse
from arango_cve_processor.cti_processor import ArangoProcessor
from arango_cve_processor.config import MODE_COLLECTION_MAP
...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        required=False,
        help=".",
        default="generated by arango_cve_processor",
    )
    parser.add_argument(
        "--database",
        required=True,
